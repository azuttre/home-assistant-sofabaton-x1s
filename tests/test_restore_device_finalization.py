    ...
    *,
    ...
    return {
        ...
        "device": {
            ...
            "channel": 0,
            "power_state": 0,
            # 0.6.8 no longer substitutes the unrelated power_mode record
            # byte when this dedicated capture is missing. Keep the fixture
            # explicit so its expected family-0x41 step tests current behavior.
            "idle_behavior": 1 if with_replay_records else 0,
            "ip_address": None,
            "poll_time": -1,
