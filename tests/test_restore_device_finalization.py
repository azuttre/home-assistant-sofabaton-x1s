    ...
    *,
    ...
    return {
        ...
        "device": {
            ...
            "channel": 0,
            "power_state": 0,
            # Restore does not substitute the unrelated power_mode record byte
            # when this dedicated capture is missing. Keep the fixture explicit
            # so its expected family-0x41 step tests current behavior.
