...
class RestoreMixin:
    ...
    def _build_restore_device_finalize_step(
        ...
        *,
        ...
        Every device restore profile ends with the same family-0x08 record.
        Keeping that construction here prevents the X1 and X1S/X2 pipelines
        from drifting on the persistence boundary, and deliberately replaces
        any source or provisional id carried by the backup/create record with
        the id returned in the family-0x07 acknowledgement.
        """
