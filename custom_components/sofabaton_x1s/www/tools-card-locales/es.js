...
var TOOLS_CARD_STRINGS_ES = {
  ...
  backend: {
    ...
    versionMismatchTitle: "Recarga la p\xE1gina para actualizar la tarjeta Panel de control Sofabaton",
  ...
  errors: {
    ...
    irLearnNoSocket: "El aprendizaje no est\xE1 disponible sin una conexi\xF3n WebSocket",
  ...
  settings: {
    ...
    wifiDeviceDescription: "Activa el listener HTTP que captura pulsaciones del mando a distancia y las dirige a acciones de HA.",
    findRemoteTitle: "Buscar mando a distancia",
    findRemoteDescription: "Haz que el mando a distancia emita un pitido para poder encontrarlo.",
    syncRemoteTitle: "Sincronizar mando a distancia",
    syncRemoteDescription: "Env\xEDa la configuraci\xF3n m\xE1s reciente al mando a distancia f\xEDsico."
  },
  cache: {
    loading: "Cargando\u2026",
    noHubsFound: "No se encontraron hubs.",
  ...
  hubClick: {
    notificationTitle: "\u{1F6E0}\uFE0F Asistente de automatizaci\xF3n",
    ...
    noRemoteEntity: "La entidad de mando a distancia del hub no est\xE1 disponible.",
  ...
  backendState: {
    operationBackup: "Creando copia de seguridad",
    operationRestore: "Restaurando copia de seguridad",
    ...
    backupPreparing: "Preparando la copia de seguridad\u2026",
    backupDevice: (id) => `Creando copia de seguridad del dispositivo ${id}\u2026`,
    backupActivity: (id) => `Creando copia de seguridad de la actividad ${id}\u2026`,
    backupFinalizing: "Finalizando la copia de seguridad\u2026",
    restoreValidating: "Comprobando la copia de seguridad\u2026",
    ...
    entityStepActivityRename: "Renombrando la actividad\u2026",
    entityStepBindingDelete: "Borrando una asignaci\xF3n de bot\xF3n\u2026",
    ...
    entityStepDeviceRename: "Renombrando el dispositivo\u2026",
    entityStepFavoriteAdd: "A\xF1adiendo un acceso directo\u2026",
    entityStepFavoriteDelete: "Eliminando un acceso directo\u2026",
    entityStepFavoriteOrder: "Reordenando los accesos directos\u2026",
    entityStepIdleBehavior: "Actualizando el encendido y apagado autom\xE1tico\u2026",
    entityStepInputsWrite: (id) => id == null ? "Actualizando las entradas\u2026" : `Actualizando las entradas del dispositivo ${id}\u2026`,
    entityStepMacroDelete: "Eliminando una macro\u2026",
    entityStepMacroPowerOn: "Actualizando la secuencia de inicio\u2026",
    entityStepMacroPowerOff: "Actualizando la secuencia de fin\u2026",
    entityStepMacroCustom: "Actualizando una macro\u2026",
    entityStepMemberReplay: "A\xF1adiendo un dispositivo a la actividad\u2026",
    entityStepRemoteSync: "Sincronizando el mando a distancia\u2026",
    wifiSyncing: "Sincronizando Wifi Commands\u2026",
    wifiStarting: "Iniciando la sincronizaci\xF3n\u2026",
    ...
    wifiAddingToActivities: "A\xF1adiendo el dispositivo Wifi a las actividades\u2026",
    ...
    wifiResyncingRemote: "Resincronizando el mando a distancia\u2026",
    wifiStepCommandAdd: (name) => name == null ? "A\xF1adiendo un comando\u2026" : `A\xF1adiendo el comando \xAB${name}\xBB\u2026`,
    wifiStepCommandPayload: (name) => name == null ? "Actualizando un comando\u2026" : `Actualizando el comando \xAB${name}\xBB\u2026`,
    wifiStepCommandRename: (name) => name == null ? "Renombrando un comando\u2026" : `Renombrando el comando como \xAB${name}\xBB\u2026`,
    wifiStepCommandDelete: (name) => name == null ? "Eliminando un comando\u2026" : `Eliminando el comando \xAB${name}\xBB\u2026`,
    wifiStepPowerConfig: "Actualizando el encendido y apagado autom\xE1tico\u2026",
    wifiStepInputConfig: "Actualizando la configuraci\xF3n de entradas\u2026",
    wifiStepInputSelect: "Actualizando la selecci\xF3n de entrada\u2026",
    wifiStepActivityJoin: "A\xF1adiendo el dispositivo a una actividad\u2026",
    wifiStepActivityLeave: "Retirando el dispositivo de una actividad\u2026",
    wifiStepHeadCommit: "Guardando el dispositivo\u2026",
    wifiStepBindingWrite: "Asignando un bot\xF3n\u2026",
    wifiUpdatedInPlace: "Dispositivo Wifi actualizado.",
    wifiAlreadyCurrent: "El dispositivo Wifi ya est\xE1 actualizado.",
  ...
  backup: {
    ...
    reorderHint: " Arrastra el tirador de una fila para reordenar actividades y dispositivos.",
    macroStepsSortableHelp: "Arrastra para reordenar. Cada paso reproduce un comando; configura debajo la espera que le sigue.",
    macroStepsHelp: "Cada paso reproduce un comando; configura debajo la espera que le sigue.",
    ...
    deleteImpactActivities: (count) => `${count} ${count === 1 ? "actividad hace" : "actividades hacen"} referencia a este elemento`,
    ...
    buttonBindingsActivitySub: "Asigna botones del mando a distancia a un comando de dispositivo dentro de esta actividad.",
    buttonBindingsDeviceSub: "Asigna botones del mando a distancia a los comandos propios de este dispositivo.",
    ...
    addMemberHelper: "El dispositivo se a\xF1ade a las secuencias de encendido y apagado. Puedes asignar botones o accesos directos m\xE1s tarde, o dejar las secuencias vac\xEDas.",
    addMemberConfirm: "A\xF1adir",
    addMemberNoneLeft: "Todos los dispositivos ya forman parte de esta actividad.",
    ...
    powerControlStayOnSub: "Evita la espera para volver a encenderlo; aun as\xED se apaga con el bot\xF3n Apagar del mando a distancia.",
    ...
    powerActivitySub: "Aqu\xED se enciende cada dispositivo usado por la actividad. Elige su entrada y ajusta los tiempos.",
    ...
    activityRunningTitle: "Botones del mando a distancia",
    activityRunningSub: "Qu\xE9 dispositivo controla cada bot\xF3n del mando a distancia en esta actividad.",
    activityShortcutsTitle: "Accesos directos en la pantalla del mando a distancia",
    activityShortcutsSubSortable: "Comandos y macros mostrados en la pantalla del mando a distancia. Arrastra el tirador para reordenarlos.",
    activityShortcutsSubStatic: "Comandos y macros mostrados en la pantalla del mando a distancia. Usa los botones de movimiento para reordenarlos.",
    ...
    prontoHexHelper: "Pega un c\xF3digo Pronto Hex en formato aprendido, como \xAB0000 006D 0022 0000 00AB \u2026\xBB, o un c\xF3digo HEX compatible de Unfolded Circle, como \xAB3;0x4B36D32C;32;0\xBB. El editor lo convierte autom\xE1ticamente en bytes de Sofabaton.",
    prontoUnavailable: "Esta carga \xFAtil no se puede leer como duraciones IR sin procesar, por lo que no puede mostrarse como Pronto Hex.",
    invalidProntoHex: "Este no es un c\xF3digo Pronto Hex v\xE1lido en formato aprendido.",
    descriptorX2Only: "Las cargas \xFAtiles IR descriptivas solo se admiten en hubs X2.",
    // Importación de códigos HEX de Unfolded Circle (convertidos en el backend mediante infrared-protocols).
    ucHexConverting: "Convirtiendo el c\xF3digo HEX de Unfolded Circle\u2026",
    ucHexInvalid: "Este no es un c\xF3digo HEX de Unfolded Circle v\xE1lido.",
    ucHexUnknownProtocol: "un protocolo desconocido",
    ucHexUnsupported: (protocol) => `Este c\xF3digo HEX de Unfolded Circle usa ${protocol}, que no es compatible. En su lugar, exporta el comando desde Unfolded Circle en formato Pronto Hex y p\xE9galo aqu\xED.`,
    ucHexUnrepresentable: "Este c\xF3digo HEX de Unfolded Circle no cumple las reglas de formato de su protocolo IR y no se puede convertir. Exporta el comando desde Unfolded Circle en formato Pronto Hex y p\xE9galo aqu\xED.",
    ucHexUnavailable: "La conversi\xF3n de c\xF3digos HEX de Unfolded Circle no est\xE1 disponible porque la biblioteca infrared-protocols necesaria no se puede cargar en esta instalaci\xF3n de Home Assistant.",
    ucHexNoHost: "Este editor no puede convertir c\xF3digos HEX de Unfolded Circle porque necesita una conexi\xF3n con Home Assistant.",
    ucHexFailed: "No se pudo convertir el c\xF3digo HEX de Unfolded Circle.",
    // Modo de aprendizaje del editor de cargas útiles (IR9).
    learn: "Aprender",
    learnAria: "Aprender una carga \xFAtil desde otro mando a distancia o desde Home Assistant",
    learnBack: "Atr\xE1s",
    learnTryAgain: "Reintentar",
    learnFromHub: "Desde otro mando a distancia",
    learnFromHubDescription: "El receptor del hub espera una pulsaci\xF3n del mando a distancia IR cuyo comando quieres aprender.",
    learnFromHa: "Desde Home Assistant",
    learnFromHaDescription: "Todo lo que otra integraci\xF3n env\xEDe a trav\xE9s del emisor de infrarrojos del hub aparece aqu\xED, listo para guardar.",
    learnHaChecking: "Comprobando qu\xE9 integraciones usan el emisor del hub\u2026",
    learnHubArming: "Activando el receptor del hub\u2026",
    learnHubListening: "Apunta ese mando a distancia al hub y pulsa el bot\xF3n una vez.",
    learnHubCountdown: (left) => `Escuchando\u2026 ${left}`,
    learnHubLearned: (timings, khz) => `Aprendido del mando a distancia de origen: ${timings} duraciones de se\xF1al a ${khz} kHz. Pru\xE9balo y luego guarda.`,
    learnHubLearnedRaw: "Aprendido del mando a distancia de origen. Pru\xE9balo y luego guarda.",
    learnHubTimedOut: "No lleg\xF3 ninguna se\xF1al antes de que se cerrara la ventana de aprendizaje del hub.",
    learnHubInterrupted: (by) => `Otra comunicaci\xF3n con el hub cerr\xF3 la ventana de aprendizaje (${by}).`,
    learnHubCancelled: "Aprendizaje cancelado.",
    learnHubRefused: "El hub no entr\xF3 en modo de aprendizaje. \xBFEst\xE1 conectada la aplicaci\xF3n Sofabaton o hay una sincronizaci\xF3n en curso?",
    learnHubFailed: "El aprendizaje fall\xF3.",
    learnHubNoPayload: "El hub capt\xF3 una se\xF1al, pero no se pudo leer su carga \xFAtil.",
    learnHaHelper: "Env\xEDa un comando desde Home Assistant a trav\xE9s del emisor del hub; aparecer\xE1 abajo en cuanto el hub lo reproduzca. Puedes salir de esta p\xE1gina y volver m\xE1s tarde.",
    learnHaConsumers: "Integraciones que usan el emisor de este hub",
    learnHaEmpty: "A\xFAn no se ha captado nada.",
    learnHaNew: "nuevo",
    learnHaUse: "Usar",
    learnHaSentCount: (count) => `\xD7${count}`,
    learnHaCaptured: (label) => `Captado desde Home Assistant: ${label}. Pru\xE9balo y luego guarda.`,
    learnHaUnavailable: "No se pudieron cargar los comandos IR emitidos recientemente.",
    learnJustNow: "ahora mismo",
    learnSecondsAgo: (seconds) => `hace ${seconds} s`,
    learnMinutesAgo: (minutes) => `hace ${minutes} min`,
    learnHoursAgo: (hours) => `hace ${hours} h`,
  ...
  decodedPayload: {
    ...
    mqttSubtitle: "El hub ignora ambos bytes: al pulsar, publica sus propios identificadores de dispositivo y de tecla en el broker. No hay nada que configurar.",
    mqttDeviceId: "ID del dispositivo (ignorado por el hub)",
    mqttCommandId: "ID del comando (ignorado por el hub)",
  ...
  wifiCommands: {
    ...
    sectionSubtitle: "Usa Wifi Commands para ejecutar acciones de Home Assistant desde los botones de tu mando a distancia f\xEDsico. Elige un dispositivo Wifi para editar sus espacios de comando o a\xF1ade uno nuevo.",
    addDeviceButton: "A\xF1adir",
    addDevice: "A\xF1adir dispositivo Wifi",
    deleteDeviceAria: "Eliminar dispositivo Wifi",
    emptyDevices: "Todav\xEDa no hay dispositivos Wifi configurados. A\xF1ade uno para empezar a asignar espacios de comando.",
    ...
    inActivities: (count) => `en ${count} ${count === 1 ? "actividad" : "actividades"}`,
    ...
    none: "Ninguno",
    commandSlotDescription: "Crea un comando en este espacio. As\xEDgnale un nombre y decide a qu\xE9 actividades aplicarlo. El nombre aparecer\xE1 en la pantalla del mando a distancia, en la aplicaci\xF3n m\xF3vil y como estado del sensor de Wifi Commands.",
    ...
    syncMessageRemoteUnavailable: "Entidad de mando a distancia no disponible. \xBFEst\xE1 conectada la aplicaci\xF3n?",
    ...
    transportLabel: "M\xE9todo de transmisi\xF3n",
    transportMqttHint: "Transmisi\xF3n m\xE1s r\xE1pida a trav\xE9s del broker MQTT; no se necesita el listener HTTP de Sofabaton en el puerto 8060. El hub debe poder conectarse al broker configurado en la aplicaci\xF3n de Sofabaton.",
    transportHttpHint: "El hub llama a Home Assistant directamente por tu red.",
    transportLockedNote: "El m\xE9todo no se puede cambiar despu\xE9s de sincronizar el dispositivo con el hub.",
    transportPillDeployedTitle: "M\xE9todo de transmisi\xF3n actual",
    transportPillPreviewTitle: "M\xE9todo de transmisi\xF3n seleccionado",
    deleteModalTitle: "\xBFEliminar dispositivo Wifi?",
    deleteModalBody: (deviceName) => `\xBFEliminar \xAB${deviceName}\xBB del hub y borrar su configuraci\xF3n guardada de espacios de comando?`,
    ...
    hubEventClearTitle: "Restablecer a \xABno hacer nada\xBB",
    ...
    wifiEventsSubtitle: "Eventos creados desde el editor de actividades. Pulsarlos en el mando a distancia dispara aqu\xED su acci\xF3n de Home Assistant (tambi\xE9n actualizan el sensor de Wifi Commands).",
    wifiEventsEmpty: "Todav\xEDa no hay eventos Wifi. Cr\xE9alos desde los di\xE1logos de a\xF1adir del editor de actividades (accesos directos, botones y pasos de macro).",
    eventsConfiguredPill: (configured, total) => `${configured} de ${total} configurado${configured === 1 ? "" : "s"}`,
    eventsShowUnconfigured: (count) => `Mostrar ${count} sin configurar\u2026`,
    ...
    wifiEventsStaleNoticePrefix: "Estos eventos ya no est\xE1n en el hub. A\xF1ade uno a una actividad para volver a desplegarlos todos, o ",
    wifiEventsStaleNoticeLink: "elimina esta configuraci\xF3n de Home Assistant",
    wifiEventsStaleNoticeSuffix: ".",
    wifiEventsStaleConfirmText: "\xBFEliminar todos los eventos Wifi y sus acciones de Home Assistant?",
    wifiEventsStaleConfirmRemove: "Eliminar",
    wifiEventsStaleRemoveFailed: "No se pudo eliminar la configuraci\xF3n de eventos Wifi.",
    ...
    actionModalNote: "Ejecuta una acci\xF3n cada vez que se ejecute el comando. Configurar una acci\xF3n es opcional; puedes crear tus propias automatizaciones que se activen desde el sensor de Wifi Commands.",
    ...
    selectTriggeredAction: "Seleccionar acci\xF3n a ejecutar",
    action: "Acci\xF3n",
    save: "Guardar",
    keyLabels: {
      up: "Arriba",
