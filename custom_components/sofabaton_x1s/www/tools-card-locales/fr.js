...
var TOOLS_CARD_STRINGS_FR = {
  ...
  backup: {
    ...
    prontoHexHelper: "Collez un code Pronto Hex au format appris, tel que \xAB\xA00000 006D 0022 0000 00AB \u2026\xA0\xBB, ou un code HEX pris en charge au format Unfolded Circle, tel que \xAB\xA03;0x4B36D32C;32;0\xA0\xBB. L\u2019\xE9diteur le convertit automatiquement en octets Sofabaton.",
    ...
    ucHexUnsupported: (protocol) => `Ce code HEX au format Unfolded Circle utilise ${protocol}, qui n\u2019est pas pris en charge. Exportez plut\xF4t la commande depuis Unfolded Circle au format Pronto Hex, puis collez-la ici.`,
    ucHexUnrepresentable: "Ce code HEX au format Unfolded Circle ne respecte pas les r\xE8gles de format de son protocole IR et ne peut pas \xEAtre converti. Exportez la commande depuis Unfolded Circle au format Pronto Hex, puis collez-la ici.",
    ucHexUnavailable: "La conversion des codes HEX au format Unfolded Circle n\u2019est pas disponible, car la biblioth\xE8que infrared-protocols requise ne peut pas \xEAtre charg\xE9e dans cette installation de Home Assistant.",
    ucHexNoHost: "Cet \xE9diteur ne peut pas convertir les codes HEX au format Unfolded Circle, car une connexion \xE0 Home Assistant est n\xE9cessaire.",
    ucHexFailed: "La conversion du code HEX au format Unfolded Circle a \xE9chou\xE9.",
