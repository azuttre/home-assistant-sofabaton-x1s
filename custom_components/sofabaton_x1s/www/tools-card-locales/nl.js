...
var TOOLS_CARD_STRINGS_NL = {
  ...
  availability: {
    ...
    blockedByFirmware: (installed, required) => `Op deze hub is firmwareversie ${installed} ge\xEFnstalleerd. Voor functies van het bedieningspaneel die de hubconfiguratie wijzigen, is minimaal versie ${required} vereist. Werk de hub bij met de Sofabaton-app. Deze functie wordt automatisch weer beschikbaar zodra de hub de bijgewerkte firmwareversie doorgeeft.`
  },
  buttonNames: {
    151: "C",
    152: "B",
  ...
  hubClick: {
    notificationTitle: "\u{1F6E0}\uFE0F Automatiseringshulp",
    ...
    noRemoteEntity: "De afstandsbedieningsentiteit van de hub is niet beschikbaar.",
  ...
  backendState: {
    operationBackup: "Back-up wordt gemaakt",
    operationRestore: "Back-up wordt hersteld",
    operationCacheRefresh: "Hubcache wordt vernieuwd",
    operationEntitySync: "Synchronisatie met hub wordt uitgevoerd",
    operationWifiDeploy: "Wifi Commands worden gesynchroniseerd",
    working: "Bezig\u2026",
    ...
    entityComplete: "Gesynchroniseerd met de hub.",
    entityStepActivityRename: "Activiteit hernoemen\u2026",
    entityStepBindingDelete: "Een knoptoewijzing wissen\u2026",
    ...
    entityStepDeviceRename: "Apparaat hernoemen\u2026",
    entityStepFavoriteAdd: "Een snelkoppeling toevoegen\u2026",
    entityStepFavoriteDelete: "Een snelkoppeling verwijderen\u2026",
    entityStepFavoriteOrder: "Snelkoppelingen herordenen\u2026",
    entityStepIdleBehavior: "Automatisch in- en uitschakelen bijwerken\u2026",
    entityStepInputsWrite: (id) => id == null ? "Ingangen bijwerken\u2026" : `Ingangen bijwerken op apparaat ${id}\u2026`,
    entityStepMacroDelete: "Een macro verwijderen\u2026",
    entityStepMacroPowerOn: "Startsequentie bijwerken\u2026",
    entityStepMacroPowerOff: "Eindsequentie bijwerken\u2026",
    entityStepMacroCustom: "Een macro bijwerken\u2026",
    entityStepMemberReplay: "Een apparaat aan de activiteit toevoegen\u2026",
    entityStepRemoteSync: "Afstandsbediening synchroniseren\u2026",
    ...
    wifiStepCommandAdd: (name) => name == null ? "Een commando toevoegen\u2026" : `Commando "${name}" toevoegen\u2026`,
    wifiStepCommandPayload: (name) => name == null ? "Een commando bijwerken\u2026" : `Commando "${name}" bijwerken\u2026`,
    wifiStepCommandRename: (name) => name == null ? "Een commando hernoemen\u2026" : `Commando hernoemen naar "${name}"\u2026`,
    wifiStepCommandDelete: (name) => name == null ? "Een commando verwijderen\u2026" : `Commando "${name}" verwijderen\u2026`,
    wifiStepPowerConfig: "Automatisch in- en uitschakelen bijwerken\u2026",
    wifiStepInputConfig: "Ingangsconfiguratie bijwerken\u2026",
    wifiStepInputSelect: "Ingangsselectie bijwerken\u2026",
    wifiStepActivityJoin: "Het apparaat aan een activiteit toevoegen\u2026",
    wifiStepActivityLeave: "Het apparaat uit een activiteit verwijderen\u2026",
    wifiStepHeadCommit: "Apparaat opslaan\u2026",
    wifiStepBindingWrite: "Een knop toewijzen\u2026",
  ...
  activities: {
    ...
    syncRetry: "Opnieuw synchroniseren",
  ...
  backup: {
    ...
    wifiDeviceDeployedSuccessfully: "Wifi-apparaat succesvol uitgerold.",
    ...
    buttonBindingsTitle: "Knoptoewijzingen",
    buttonBindingsActivitySub: "Wijs knoppen van de afstandsbediening binnen deze activiteit toe aan een apparaatcommando.",
    buttonBindingsDeviceSub: "Wijs knoppen van de afstandsbediening toe aan de eigen commando's van dit apparaat.",
    buttonBindingsEmpty: "Geen knoptoewijzingen geconfigureerd.",
    addBinding: "Toewijzing toevoegen",
    bindingButton: "Knop",
    bindingTargetDevice: "Apparaat",
    bindingCommand: "Commando",
    bindingEnableLongPress: "Toewijzing voor lang indrukken inschakelen",
    ...
    bindingNoButtons: "Elke knop op dit hubmodel is al toegewezen.",
    bindingNoCommands: "Dit apparaat heeft geen commando's om toe te wijzen.",
    bindingNoDevices: "Deze back-up bevat geen apparaten met commando's om toe te wijzen.",
    bindingAdd: "Toevoegen",
    bindingSave: "Opslaan",
    bindingCancel: "Annuleren",
    bindingDialogAddTitle: "Knoptoewijzing toevoegen",
    bindingDialogEditTitle: (name) => `Toewijzing voor ${name} bewerken`,
    bindingLongPressMeta: (label) => `Lang indrukken \xB7 ${label}`,
    deleteBindingTitle: (name) => `Toewijzing voor ${name} verwijderen?`,
    deleteBindingAria: "Toewijzing verwijderen",
    deleteImpactBindings: (count) => `${count} ${count === 1 ? "knoptoewijzing wordt" : "knoptoewijzingen worden"} gewist`,
    macrosTitle: "Macro's",
    ...
    addMemberConfirm: "Toevoegen",
    addMemberNoneLeft: "Alle apparaten maken al deel uit van deze activiteit.",
    ...
    powerNoDevices: "Nog geen apparaten. Voeg een favoriet, toewijzing of macro toe die er een gebruikt.",
    ...
    wifiEventNeedsSync: (name) => `${name} (synchronisatie nodig)`,
    ...
    managedWifiIntro: "Dit apparaat is vanuit het tabblad Wifi Commands uitgerold.",
    ...
    editBindingAria: "Toewijzing bewerken",
    ...
    test: "Testen",
    payloadDocsLink: "Payload-documentatie",
    ...
    prontoHexHelper: 'Plak een Pronto Hex-code in aangeleerd formaat, zoals "0000 006D 0022 0000 00AB \u2026", of een ondersteunde HEX-code in Unfolded Circle-formaat, zoals "3;0x4B36D32C;32;0". De editor zet deze automatisch om in Sofabaton-bytes.',
    prontoUnavailable: "Deze payload is niet leesbaar als ruwe IR-timingwaarden en kan daarom niet als Pronto Hex worden getoond.",
    ...
    ucHexUnsupported: (protocol) => `Deze HEX-code in Unfolded Circle-formaat gebruikt ${protocol}; dat wordt niet ondersteund. Exporteer het commando daarom vanuit Unfolded Circle in Pronto Hex-formaat en plak het hier.`,
    ucHexUnrepresentable: "Deze HEX-code in Unfolded Circle-formaat voldoet niet aan de formatregels van zijn IR-protocol en kan niet worden omgezet. Exporteer het commando vanuit Unfolded Circle in Pronto Hex-formaat en plak het hier.",
    ucHexUnavailable: "HEX-codes in Unfolded Circle-formaat kunnen niet worden omgezet, omdat de vereiste bibliotheek infrared-protocols niet kan worden geladen in deze Home Assistant-installatie.",
    ucHexNoHost: "Deze editor kan HEX-codes in Unfolded Circle-formaat niet omzetten, omdat daarvoor een verbinding met Home Assistant nodig is.",
    ...
    learnFromHubDescription: "De ontvanger van de hub wacht op \xE9\xE9n knopdruk van de IR-afstandsbediening waarvan je het commando wilt inleren.",
    learnFromHa: "Vanuit Home Assistant",
    learnFromHaDescription: "Alles wat een andere integratie via de infraroodzender van de hub verstuurt, komt hier terecht, klaar om op te slaan.",
    ...
    learnHubListening: "Richt die afstandsbediening op de hub en druk \xE9\xE9n keer op de knop.",
    learnHubCountdown: (left) => `Luisteren\u2026 ${left}`,
    learnHubLearned: (timings, khz) => `Ingeleerd vanaf de bronafstandsbediening: ${timings} timingwaarden bij ${khz} kHz. Test het en sla het daarna op.`,
    ...
    learnHubInterrupted: (by) => `Andere communicatie met de hub heeft het inleervenster be\xEBindigd (${by}).`,
    ...
    learnHaHelper: "Verstuur vanuit Home Assistant een commando via de zender van de hub; het verschijnt hieronder zodra de hub het afspeelt. Je kunt deze pagina verlaten en later terugkomen.",
    ...
    learnHaCaptured: (label) => `Opgevangen vanuit Home Assistant: ${label}. Test het en sla het daarna op.`,
    learnHaUnavailable: "Recent verzonden IR-commando's konden niet worden geladen.",
    learnJustNow: "zojuist",
    learnSecondsAgo: (seconds) => `${seconds} s geleden`,
    learnMinutesAgo: (minutes) => `${minutes} min geleden`,
    learnHoursAgo: (hours) => `${hours} u geleden`,
  ...
  decodedPayload: {
    ...
    mqttTitle: "MQTT-id's",
    mqttSubtitle: "Beide bytes worden door de hub genegeerd: bij een druk publiceert hij zijn eigen apparaat- en toets-id's naar de broker. Er valt niets te configureren.",
    mqttDeviceId: "Apparaat-id (genegeerd door de hub)",
    mqttCommandId: "Commando-id (genegeerd door de hub)",
  ...
  wifiCommands: {
    ...
    deployingTitle: "Wifi Commands uitrollen",
    ...
    inActivities: (count) => `in ${count} ${count === 1 ? "activiteit" : "activiteiten"}`,
    ...
    startSync: "Synchronisatie wordt gestart",
    ...
    transportMqttHint: "Snellere overdracht via je MQTT-broker; de HTTP-listener van Sofabaton op poort 8060 is niet nodig. De hub moet de broker kunnen bereiken die in de Sofabaton-app is ingesteld.",
    transportHttpHint: "De hub roept Home Assistant rechtstreeks aan via je netwerk.",
    transportLockedNote: "De overdrachtsmethode kan niet meer worden gewijzigd nadat het apparaat met de hub is gesynchroniseerd.",
    transportPillDeployedTitle: "Huidige overdrachtsmethode",
    transportPillPreviewTitle: "Geselecteerde overdrachtsmethode",
    ...
    clearSlotSubtitle: "De configuratie wordt gewist.",
    clearSlotNo: "Nee",
    clearSlotYes: "Ja",
    ...
    wifiEventsStaleNoticePrefix: "Deze gebeurtenissen staan niet meer op de hub. Voeg er een aan een activiteit toe om ze allemaal opnieuw naar de hub te sturen, of ",
