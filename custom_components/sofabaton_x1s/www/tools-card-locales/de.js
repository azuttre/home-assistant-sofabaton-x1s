...
var TOOLS_CARD_STRINGS_DE = {
  ...
  availability: {
    ...
    appConnectedOnlyLogs: "Solange die Sofabaton-App verbunden ist, ist nur \u201EProtokolle\u201C verf\xFCgbar.",
    hubCommandInProgress: "Hub-Befehl wird ausgef\xFChrt\u2026",
    refreshingCache: "Cache wird aktualisiert\u2026",
  ...
  errors: {
    ...
    irLearnNoSocket: "Anlernen ist ohne Websocket-Verbindung nicht verf\xFCgbar",
  ...
  hubClick: {
    notificationTitle: "\u{1F6E0}\uFE0F Automatisierungsassistent",
    ...
    noRemoteEntity: "Die Fernsteuerungsentit\xE4t des Hubs ist nicht verf\xFCgbar.",
  ...
  backendState: {
    ...
    operationEntitySync: "Wird mit dem Hub synchronisiert",
    ...
    entitySettling: "Warten, bis der Hub die \xC4nderungen vollst\xE4ndig verarbeitet hat\u2026",
    entityRefreshing: "Zwischengespeicherter Hub-Status wird aktualisiert\u2026",
    entityComplete: "Mit Hub synchronisiert.",
    entityStepActivityRename: "Aktivit\xE4t wird umbenannt\u2026",
    entityStepBindingDelete: "Tastenbelegung wird entfernt\u2026",
    ...
    entityStepDeviceRename: "Ger\xE4t wird umbenannt\u2026",
    entityStepFavoriteAdd: "Verkn\xFCpfung wird hinzugef\xFCgt\u2026",
    entityStepFavoriteDelete: "Verkn\xFCpfung wird entfernt\u2026",
    entityStepFavoriteOrder: "Verkn\xFCpfungen werden neu geordnet\u2026",
    entityStepIdleBehavior: "Automatisches Ein- und Ausschalten wird aktualisiert\u2026",
    entityStepInputsWrite: (id) => id == null ? "Eing\xE4nge werden aktualisiert\u2026" : `Eing\xE4nge auf Ger\xE4t ${id} werden aktualisiert\u2026`,
    entityStepMacroDelete: "Makro wird entfernt\u2026",
    entityStepMacroPowerOn: "Startsequenz wird aktualisiert\u2026",
    entityStepMacroPowerOff: "Endsequenz wird aktualisiert\u2026",
    entityStepMacroCustom: "Makro wird aktualisiert\u2026",
    entityStepMemberReplay: "Ger\xE4t wird zur Aktivit\xE4t hinzugef\xFCgt\u2026",
    entityStepRemoteSync: "Fernbedienung wird synchronisiert\u2026",
    wifiSyncing: "Wifi Commands werden synchronisiert\u2026",
    wifiStarting: "Synchronisierung wird gestartet\u2026",
    wifiReadingDevice: "Bereitgestelltes WLAN-Ger\xE4t wird gelesen\u2026",
    wifiEnablingDevice: "WLAN-Ger\xE4t wird aktiviert\u2026",
    wifiDisablingDevice: "WLAN-Ger\xE4t wird deaktiviert\u2026",
    wifiValidatingActivities: "Aktivit\xE4ten werden mit dem Hub abgeglichen\u2026",
    wifiCreatingDevice: "WLAN-Ger\xE4t wird auf dem Hub erstellt\u2026",
    wifiDeletingDevice: "Vorheriges WLAN-Ger\xE4t wird entfernt\u2026",
    wifiAddingToActivities: "WLAN-Ger\xE4t wird zu Aktivit\xE4ten hinzugef\xFCgt\u2026",
    wifiApplyingFavorites: "Verkn\xFCpfungen der Aktivit\xE4ten werden angewendet\u2026",
    wifiApplyingBindings: "Tastenbelegungen werden angewendet\u2026",
    wifiRefreshingMaps: "Tasten und Verkn\xFCpfungen werden aktualisiert\u2026",
    wifiResyncingRemote: "Fernbedienung wird neu synchronisiert\u2026",
    wifiStepCommandAdd: (name) => name == null ? "Befehl wird hinzugef\xFCgt\u2026" : `Befehl "${name}" wird hinzugef\xFCgt\u2026`,
    wifiStepCommandPayload: (name) => name == null ? "Befehl wird aktualisiert\u2026" : `Befehl "${name}" wird aktualisiert\u2026`,
    wifiStepCommandRename: (name) => name == null ? "Befehl wird umbenannt\u2026" : `Befehl wird in "${name}" umbenannt\u2026`,
    wifiStepCommandDelete: (name) => name == null ? "Befehl wird entfernt\u2026" : `Befehl "${name}" wird entfernt\u2026`,
    wifiStepPowerConfig: "Automatisches Ein- und Ausschalten wird aktualisiert\u2026",
    wifiStepInputConfig: "Eingangskonfiguration wird aktualisiert\u2026",
    wifiStepInputSelect: "Eingangsauswahl wird aktualisiert\u2026",
    wifiStepActivityJoin: "Ger\xE4t wird zu einer Aktivit\xE4t hinzugef\xFCgt\u2026",
    wifiStepActivityLeave: "Ger\xE4t wird aus einer Aktivit\xE4t entfernt\u2026",
    wifiStepHeadCommit: "Ger\xE4t wird gespeichert\u2026",
    wifiStepBindingWrite: "Taste wird zugewiesen\u2026",
    wifiUpdatedInPlace: "WLAN-Ger\xE4t aktualisiert.",
    wifiAlreadyCurrent: "WLAN-Ger\xE4t ist bereits aktuell.",
    wifiDeviceRemoved: "WLAN-Ger\xE4t entfernt \u2014 keine Befehle konfiguriert.",
  ...
  activities: {
    ...
    syncRetry: "Erneut synchronisieren",
  ...
  backup: {
    ...
    macroStepsSortableHelp: "Zum Neuordnen ziehen. Jeder Schritt spielt einen Befehl ab; stelle darunter die anschlie\xDFende Wartezeit ein.",
    macroStepsHelp: "Jeder Schritt spielt einen Befehl ab; stelle darunter die anschlie\xDFende Wartezeit ein.",
    hubName: "Hub-Name",
    ...
    addMemberHelper: "Das Ger\xE4t wird beiden Ein-/Ausschaltsequenzen hinzugef\xFCgt. Tasten oder Verkn\xFCpfungen kannst du sp\xE4ter zuweisen; die Sequenzen d\xFCrfen auch leer bleiben.",
    addMemberConfirm: "Hinzuf\xFCgen",
    addMemberNoneLeft: "Alle Ger\xE4te sind bereits Teil dieser Aktivit\xE4t.",
    removeMemberAria: "Ger\xE4t aus dieser Aktivit\xE4t entfernen",
    ...
    roleConfirmBody: "Diese Gruppe enth\xE4lt Tastenbelegungen, die nicht aus der Standardbelegung eines einzelnen Ger\xE4ts stammen. Eine Belegung hier ersetzt sie.",
    ...
    wifiEventNameHelper: "Das Ereignis wird jetzt vorgemerkt und beim Synchronisieren auf den Hub \xFCbertragen; eine Aktion weist du ihm unter Automatisierung \u2192 Ereignisse zu.",
    wifiEventDeploying: "Wifi-Event wird vorgemerkt\u2026",
    wifiEventNoneYet: "Noch keine Wifi-Events. Erstelle unten eines.",
    wifiEventNeedsSync: (name) => `${name} (Synchronisierung n\xF6tig)`,
    ...
    wifiEventBindingLongPressNote: "Langes Dr\xFCcken l\xF6st die Langdruck-Aktion dieses Ereignisses aus. Konfiguriere sie unter Automatisierung \u2192 Ereignisse.",
    ...
    prontoHexHelper: 'F\xFCge einen Pronto-Hex-Code im Lernformat wie "0000 006D 0022 0000 00AB \u2026" oder einen unterst\xFCtzten HEX-Code im Unfolded-Circle-Format wie "3;0x4B36D32C;32;0" ein. Der Editor wandelt ihn automatisch in Sofabaton-Bytes um.',
    prontoUnavailable: "Diese Nutzdaten lassen sich nicht als rohe IR-Zeitwerte lesen und k\xF6nnen daher nicht als Pronto Hex angezeigt werden.",
    invalidProntoHex: "Dies ist kein g\xFCltiger Pronto-Hex-Code im Lernformat.",
    descriptorX2Only: "Beschreibende IR-Nutzdaten werden nur auf X2-Hubs unterst\xFCtzt.",
    ...
    ucHexInvalid: "Dies ist kein g\xFCltiger HEX-Code im Unfolded-Circle-Format.",
    ucHexUnknownProtocol: "ein unbekanntes Protokoll",
    ucHexUnsupported: (protocol) => `Dieser HEX-Code im Unfolded-Circle-Format verwendet ${protocol}, was nicht unterst\xFCtzt wird. Exportiere den Befehl in Unfolded Circle stattdessen im Pronto-Hex-Format und f\xFCge ihn dann hier ein.`,
    ucHexUnrepresentable: "Dieser HEX-Code im Unfolded-Circle-Format entspricht nicht den Formatregeln seines IR-Protokolls und kann nicht umgewandelt werden. Exportiere den Befehl in Unfolded Circle stattdessen im Pronto-Hex-Format und f\xFCge ihn dann hier ein.",
    ucHexUnavailable: "HEX-Codes im Unfolded-Circle-Format k\xF6nnen nicht umgewandelt werden, weil die erforderliche Bibliothek infrared-protocols in dieser Home-Assistant-Installation nicht geladen werden kann.",
    ucHexNoHost: "Dieser Editor kann HEX-Codes im Unfolded-Circle-Format nicht umwandeln, da daf\xFCr eine Verbindung zu Home Assistant erforderlich ist.",
    ...
    learnFromHubDescription: "Der Empf\xE4nger des Hubs wartet auf einen Tastendruck von der IR-Fernbedienung, deren Befehl du anlernen m\xF6chtest.",
    learnFromHa: "Aus Home Assistant",
    learnFromHaDescription: "Alles, was eine andere Integration \xFCber den Infrarotsender des Hubs sendet, landet hier und kann gespeichert werden.",
    learnHaChecking: "Es wird gepr\xFCft, welche Integrationen den Sender des Hubs verwenden\u2026",
    learnHubArming: "Der Empf\xE4nger des Hubs wird zum Anlernen aktiviert\u2026",
    learnHubListening: "Richte diese Fernbedienung auf den Hub und dr\xFCcke die Taste einmal.",
    learnHubCountdown: (left) => `Warte auf Signal\u2026 ${left}`,
    learnHubLearned: (timings, khz) => `Von der anderen Fernbedienung angelernt: ${timings} IR-Zeitwerte bei ${khz} kHz. Erst testen, dann speichern.`,
    ...
    learnHubInterrupted: (by) => `Andere Hub-Kommunikation hat das Anlernfenster beendet (${by}).`,
    learnHubCancelled: "Anlernen abgebrochen.",
    learnHubRefused: "Der Hub ist nicht in den Anlernmodus gewechselt. Ist die Sofabaton-App verbunden oder l\xE4uft eine Synchronisierung?",
    ...
    learnHaHelper: "Sende aus Home Assistant einen Befehl \xFCber den Sender des Hubs; er erscheint unten, sobald der Hub ihn abspielt. Du kannst diese Seite verlassen und sp\xE4ter zur\xFCckkommen.",
    ...
    learnHaCaptured: (label) => `Aus Home Assistant \xFCbernommen: ${label}. Erst testen, dann speichern.`,
    learnHaUnavailable: "Zuletzt gesendete IR-Befehle konnten nicht geladen werden.",
    learnJustNow: "gerade eben",
    learnSecondsAgo: (seconds) => `vor ${seconds} s`,
    learnMinutesAgo: (minutes) => `vor ${minutes} min`,
    learnHoursAgo: (hours) => `vor ${hours} h`,
    ...
    buttonCatalog: {
      ...
      volumeChannel: "Lautst\xE4rke & Kanal",
  ...
  decodedPayload: {
    ...
    mqttSubtitle: "Beide Bytes werden vom Hub ignoriert: Beim Tastendruck ver\xF6ffentlicht er seine eigenen Ger\xE4te- und Tasten-IDs an den Broker. Es gibt nichts zu konfigurieren.",
    mqttDeviceId: "Ger\xE4te-ID (vom Hub ignoriert)",
    mqttCommandId: "Befehls-ID (vom Hub ignoriert)",
  ...
  wifiCommands: {
    ...
    mediaGroup: "Wiedergabe",
    abcGroup: "ABC",
    colorGroup: "Farbe",
    inputCommand: "Eingangsbefehl",
    inputFor: (activity) => `Eingang f\xFCr ${activity}`,
    inActivities: (count) => `in ${count} ${count === 1 ? "Aktivit\xE4t" : "Aktivit\xE4ten"}`,
    ...
    syncMessageRemoteUnavailable: "Fernsteuerungsentit\xE4t nicht verf\xFCgbar. Ist die App verbunden?",
    ...
    transportMqttHint: "Schnellere \xDCbertragung \xFCber den MQTT-Broker; der Sofabaton-HTTP-Listener auf Port 8060 wird nicht ben\xF6tigt. Der Hub muss den in der Sofabaton-App konfigurierten Broker erreichen k\xF6nnen.",
    transportHttpHint: "Der Hub ruft Home Assistant direkt \xFCber das Netzwerk auf.",
    transportLockedNote: "Der \xDCbertragungsweg kann nach der Synchronisierung des Ger\xE4ts mit dem Hub nicht mehr ge\xE4ndert werden.",
    transportPillDeployedTitle: "Aktueller \xDCbertragungsweg",
    transportPillPreviewTitle: "Ausgew\xE4hlter \xDCbertragungsweg",
    ...
    wifiEventLongPressToggleTitle: "Langes Dr\xFCcken aktivieren",
    wifiEventNeedsSyncBadge: "Synchronisierung n\xF6tig",
    wifiEventRetrySync: "Erneut synchronisieren",
    wifiEventsStaleNoticePrefix: "Diese Ereignisse sind nicht mehr auf dem Hub. F\xFCge eines zu einer Aktivit\xE4t hinzu, um alle erneut auf den Hub zu \xFCbertragen, oder ",
