...
export const REMOTE_CARD_STRINGS_FR = {
  card: {
    ...
    allDevicesLayout: "Disposition par défaut des appareils",
    filterCommands: "Filtrer les commandes",
    switchToDeviceMode: "Passer en mode appareil",
    switchToActivityMode: "Passer en mode activité",
    deviceKeymapMissing:
  ...
  assist: {
    ...
    notification: {
      ...
      eventCommand: (label: string) => `Commande : ${label}`,
      ...
      headerDevice: (deviceName: string, eventLabel: string) =>
        `**Appareil : ${deviceName} | ${eventLabel}**`,
  ...
  editor: {
    ...
    openOnCurrentActivity: "Activité en cours",
    ...
    noteCustomDeviceLayout: "Disposition d’appareil personnalisée utilisée",
    noteUsingActivityDefault: "Disposition par défaut des activités utilisée",
    noteUsingDeviceDefault: "Disposition par défaut des appareils utilisée",
  },
  groups: {
    activity: "Activité/appareil",
