...
export const REMOTE_CARD_STRINGS_ES = {
  ...
  editor: {
    ...
    tintedPanelsDescription:
      "Muestra un fondo tintado detrás de cada grupo de botones.",
    ...
    shortcutCommandMissing: (id: number | string) => `Comando ${id} (no encontrado)`,
    shortcutsCommandsLoading: "Cargando comandos…",
    shortcutsCommandsUnavailable:
      "Los comandos de este dispositivo aún no están en caché. Actualiza el dispositivo en la pestaña Hub del Panel de control Sofabaton y vuelve a cargar el panel de Home Assistant.",
    shortcutsCommandsError:
      "No se pudieron cargar los comandos de este dispositivo. Vuelve a cargar el panel de Home Assistant e inténtalo de nuevo.",
